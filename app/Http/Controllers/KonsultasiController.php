...
class KonsultasiController extends Controller
{
    ...
    public function diagnosa(Request $request) {
        ...
        $diagnosa = $this->hasil($pasien_id);

        return redirect()->route('hasilDiagnosa', $diagnosa->id);
    }
    ...
    private function hasil($pasien_id) {
        ...
        foreach ($temp_diag as $diag) {
            ...
            if($persentase > $max_persentase) {
                $max_persentase = $persentase;
                $max_diagnosa = Diagnosa::create([
        ...
        $this->hapusTempDiagnosa($pasien_id);

        return $this->final_diagnosa = $max_diagnosa;
    }
    ...
    public function hasilDiagnosa($diagnosa_id) {
        $diagnosa = Diagnosa::where('id', $diagnosa_id)->first();
